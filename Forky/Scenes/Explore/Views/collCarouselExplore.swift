...
class collCarouselExplore: UICollectionView {
    ...
    public convenience init(withFrame frame: CGRect, andInset inset: CGFloat) {
        self.init(frame: frame, collectionViewLayout: CarouselExploreLayout(withCarouselInset: inset))
...
fileprivate extension collCarouselExplore {
    ...
    func configureLayout() {
        ...
        collectionViewLayout = CarouselExploreLayout(
...
extension collCarouselExplore: UIScrollViewDelegate {
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        */
        ...
        for cell in visibleCells {
            if let infoCardCell = cell as? cellCarousel {
